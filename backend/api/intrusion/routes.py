...
async def start_all_feed_workers_route(current_user: dict = Depends(is_admin)):  
...
async def stop_all_feed_workers_route(current_user: dict = Depends(is_admin)):
...
async def start_feed_worker_route(worker_id: int, current_user: dict = Depends(is_admin)):
...
async def stop_feed_worker_route(worker_id: int, current_user: dict = Depends(is_admin)):
