...
const Dashboard = () => {
  ...
  const monthlyChartWidth = useMemo(
    () => Math.min(900, Math.max(560, 600 * monthlyAlertZoom)),
    [monthlyAlertZoom]
  );
      ...
      <div className="dashboard__content">
        <div className="dashboard__text__main">
          <div className="dashboard__text">
            ...
            <p>Monitor and track human intrusions across restricted areas.</p>
          </div>
        </div>
          ...
          <section className="dashboard-card">
            <div className="dashboard-card__header">
              ...
              <div className="dashboard-card__header-right">
                <div className="dashboard-chart-controls" role="group" aria-label="Monthly alerts zoom controls">
                  <button
                    type="button"
                    className="dashboard-chart-control-btn"
                    onClick={() => setMonthlyAlertZoom((value) => Math.max(0.8, Number((value - 0.2).toFixed(1))))}
                    aria-label="Zoom out monthly alerts chart"
                  >
                    −
                  </button>
                  <button
                  ...
                  <button
                    type="button"
                    className="dashboard-chart-control-btn"
                    onClick={() => setMonthlyAlertZoom((value) => Math.min(1.8, Number((value + 0.2).toFixed(1))))}
                    aria-label="Zoom in monthly alerts chart"
                  >
                    +
                  </button>
                </div>
