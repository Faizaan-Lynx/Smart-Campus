...
const HostTable = ({ siteId, heading, columns, data }) => {
  ...
  const handleDelete = async (hostId, siteId) => {
    Swal.fire({
      title: "Delete Site",
      ...
      if (result.isConfirmed) {
        try {
          ...
          await axios.delete(
            `${localurl}/dashboard/sites/${siteId}/hosts/${hostId}`,
            {
              headers: {
          ...
          if (error.response) {
            ...
            if (data && data.detail) {
              ...
              toast.error("Error deleting host. Please try again.");
            }
          } else {
    ...
    <div className="foottable__div__main">
      {showAddHostModal && (
        <AddHost
          ...
          setShowAddHostModal={setShowAddHostModal}
        />
      )}
      {showEditHostModal && (
        <EditHost
      ...
      >
        ...
        <i
          onClick={() => setShowAddHostModal(!showAddHostModal)}
